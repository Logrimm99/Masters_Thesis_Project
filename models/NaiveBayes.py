...
# CONFIGURATION
input_dir = '../unified_datasets'  # adjust path as needed
...
output_file = 'naive_bayes_output.csv'
output_path = os.path.join(output_dir, output_file)


# Optional: Set this to a dictionary to skip grid search
# best_params = None  # Set to None to enable grid search

# The best parameter combination for the 'all_sources' dataset
best_params = {'nb__alpha': 1.5, 'tfidf__min_df': 1, 'tfidf__ngram_range': (1, 3)}
