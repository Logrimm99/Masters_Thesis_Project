...
output_file = 'random_forest_output.csv'
...
best_params = {'rf__max_depth': None, 'rf__min_samples_split': 5, 'rf__n_estimators': 200, 'tfidf__min_df': 1, 'tfidf__ngram_range': (1, 2)}
