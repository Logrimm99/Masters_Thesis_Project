...
best_params = {'logreg__C': 1, 'logreg__penalty': 'l2', 'tfidf__min_df': 1, 'tfidf__ngram_range': (1, 2)}
...
if best_params is None:
    ...
    # Grid search
    grid = GridSearchCV(pipeline, param_grid, cv=cv, scoring='accuracy', n_jobs=-1, error_score='raise')
